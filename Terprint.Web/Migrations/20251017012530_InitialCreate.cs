        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dilution = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LOD = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LOQ = table.Column<string>(type: "nvarchar(max)", nullable: true),
